...
const char COMMUNITY_FORUM_URL[] = "https://cryptoentocoin.herokuapp.com";
const char REPORT_ISSUE_URL[] = "https://cryptoentocoin.cl";
...
MainWindow::MainWindow(ICryptoNoteAdapter* _cryptoNoteAdapter, IAddressBookManager* _addressBookManager,
  ...
  m_ui->setupUi(this);
  setWindowTitle(tr("entocoin Wallet %1").arg(Settings::instance().getVersion()));
